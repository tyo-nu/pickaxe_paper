...
database = f'kms_ymdb_tani_crit_{str(t_crit).replace(".", ",")}t_5gen'
# Message to insert into metadata
message = f"tanicrit generations: {t_crit}"
...
# Input compounds
input_cpds = pwd / "inputs/ymdb_smiles_sanitized_300.csv"
id_field = "id"
...
rule_list, coreactant_list, rule_name = metacyc_generalized(n_rules=100)
write_core=False
###############################################################################
...
target_cpds = pwd / "inputs/1k_BP_targets.csv"

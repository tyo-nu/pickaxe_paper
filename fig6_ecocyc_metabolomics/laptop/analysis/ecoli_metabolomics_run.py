...
# Uncomment to use these. Pickaxe doesn't come packaged with their dependencies by default.
...
write_db = True
write_core = True
database = "ecoli_metab_100t300r200"
# Message to insert into metadata
message = ("Expanding ecocyc 2gen to match sauer metabolomics")
...
generations = 2              # Total rounds of rule applications
processes = 12               # Number of processes for parallelization
...
# comment below line and uncomment other definition if using feasibility filter
...
# ...
met_data_path = "./inputs/sauer_100to300_r200.csv"
...
rt_predictor_pickle_path = None #"../RT_Prediction/final_RT_model.pickle"
...
if __name__ == "__main__":
    ...
    # Load compounds
    pk.load_compound_set(compound_file=input_cpds, id_field="id")
    ...
    pk.pickle_pickaxe(f"{database}.pk")
    ...
    pk.pickle_pickaxe(fname=f"{database}.pk")
    print("----------------------------------------")

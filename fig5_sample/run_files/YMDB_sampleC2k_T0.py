...
database = f'kms_YMDB_2ksampleC_T0'
# Message to insert into metadata
message = f"tani sample T^0: C4C9 KEGG Target C only gen {gen} and nsample {n_sample} and frac {n_frac}"
